...
export const mediaConfig: MediaConfig = {
  ...
  company: {
    workshop: {
      src: "/media/company/about-workshop-overview.webp",
    ...
    exterior: {
      src: "/media/company/contact-workshop-exterior.webp",
  ...
  services: {
    hydraulic: {
      src: "/media/services/service-hydraulic-fluid-power.webp",
    ...
    mobile: {
      src: "/media/services/service-mobile-hydraulic-works.webp",
    ...
    sealing: {
      src: "/media/services/service-sealing-solutions.webp",
    ...
    machining: {
      src: "/media/services/service-precision-machining.webp",
    ...
    fabrication: {
      src: "/media/services/service-structural-fabrication.webp",
    ...
    roofing: {
      src: "/media/services/service-roofing-works.webp",
    ...
    customMetal: {
      src: "/media/services/service-custom-gate-metal-works.webp",
  ...
  products: {
    sealing: {
      src: "/media/products/products-sealing-products.webp",
    ...
    hydraulic: {
      src: "/media/products/products-hydraulic-products.webp",
    ...
    industrial: {
      src: "/media/products/products-industrial-components.webp",
  ...
  industries: {
    heavyEquipment: {
      src: "/media/industries/industry-heavy-equipment.webp",
    ...
    constructionEquipment: {
      src: "/media/industries/industry-construction-equipment.webp",
    ...
    heavyMachinery: {
      src: "/media/industries/industry-heavy-machinery.webp",
    ...
    mining: {
      src: "/media/industries/industry-mining.webp",
    ...
    agriculturalEquipment: {
      src: "/media/industries/industry-agricultural-equipment.webp",
    ...
    manufacturing: {
      src: "/media/industries/industry-manufacturing.webp",
  ...
  projects: {
    cylinderRepair: {
      src: "/media/projects/project-cylinder-repair.webp",
    ...
    hoseReplacement: {
      src: "/media/projects/project-hose-replacement.webp",
    ...
    machining: {
      src: "/media/projects/project-machining.webp",
    ...
    fabrication: {
      src: "/media/projects/project-fabrication.webp",
    ...
    roofing: {
      src: "/media/projects/project-roofing.webp",
    ...
    customGate: {
      src: "/media/projects/project-custom-gate.webp",
